...
export default function App() {
  ...
  return (
    <div className="bg-gray-800 min-h-screen flex flex-col items-center py-10 px-4">
      <h1 className="text-4xl text-white font-bold mb-6 animate-bounce">My ToDo List</h1>
